...
use crate::geospatial::models::layer::LayerRow;
...
pub async fn load_all_layers(
    db: &sqlx::PgPool,
) -> Result<Vec<crate::geospatial::models::layer::LayerDefinition>, sqlx::Error> {
    ...
    rows.into_iter()
        .map(crate::geospatial::models::layer::LayerDefinition::try_from)
