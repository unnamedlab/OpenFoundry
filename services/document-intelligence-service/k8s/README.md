...
| Field          | Value                                                              |
|----------------|--------------------------------------------------------------------|
| Manifest       | [`infra/k8s/platform/manifests/cnpg/clusters/document-intelligence-pg.yaml`](../../../infra/k8s/platform/manifests/cnpg/clusters/document-intelligence-pg.yaml) |
