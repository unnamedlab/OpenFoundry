...
//! [`pipeline_build_service::pipeline_schedule::domain::trigger_engine`].

use pipeline_build_service::pipeline_schedule::domain::trigger::{
    CompoundOp, CompoundTrigger, CronFlavor as TriggerCronFlavor, EventTrigger, EventType,
    TimeTrigger, Trigger, TriggerKind,
};
use pipeline_build_service::pipeline_schedule::domain::trigger_engine::next_fire_for_schedule;
...
fn or_compound_with_two_time_triggers_returns_earliest_fire() {
    ...
    let schedule = pipeline_build_service::pipeline_schedule::domain::trigger::Schedule {
        id: uuid::Uuid::nil(),
        ...
        description: "".into(),
        trigger: trig,
        target: pipeline_build_service::pipeline_schedule::domain::trigger::ScheduleTarget {
            kind: pipeline_build_service::pipeline_schedule::domain::trigger::ScheduleTargetKind::SyncRun(
                pipeline_build_service::pipeline_schedule::domain::trigger::SyncRunTarget {
                    sync_rid: "x".into(),
                    source_rid: "y".into(),
                },
            ),
        ...
        active_run_id: None,
        scope_kind: pipeline_build_service::pipeline_schedule::domain::trigger::ScheduleScopeKind::User,
