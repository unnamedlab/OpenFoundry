...
pub async fn convert_to_project_scope(
    ...
    let sp = match crate::pipeline_schedule::domain::service_principal_store::create(
        &state.db,
        crate::pipeline_schedule::domain::service_principal_store::CreateServicePrincipal {
