// Package server hosts /healthz + /metrics for the action-log-sink.
// Shape lifted from services/ai-sink/internal/server to keep the
// three sinks uniform behind kubelet probes and Prometheus scrape.
package server
