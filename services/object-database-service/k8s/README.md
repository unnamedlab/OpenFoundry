...
| Field          | Value                                                              |
|----------------|--------------------------------------------------------------------|
| Manifest       | [`infra/k8s/platform/manifests/cnpg/clusters/object-database-pg.yaml`](../../../infra/k8s/platform/manifests/cnpg/clusters/object-database-pg.yaml) |
| `kind`         | `Cluster` (`postgresql.cnpg.io/v1`, CloudNativePG / cloudnative-pg)|
| Cluster name   | `object-database-pg`                                                   |
| Namespace      | `openfoundry`                                                      |
| Read/write DNS | `object-database-pg-rw.openfoundry.svc.cluster.local:5432`             |
| Read-only DNS  | `object-database-pg-ro.openfoundry.svc.cluster.local:5432`             |
| Database       | `object_database`                                                       |
| App secret     | `object-database-pg-app` (CNPG-managed; carries `username`, `password`, `uri`) |
| Backup secret  | `object-database-pg-backup` (S3 credentials for barman-cloud)          |
...
`services.object-database-service.envSecrets.DATABASE_URL`
