...
| Field          | Value                                                              |
|----------------|--------------------------------------------------------------------|
| Manifest       | [`infra/k8s/platform/manifests/cnpg/clusters/developer-console-pg.yaml`](../../../infra/k8s/platform/manifests/cnpg/clusters/developer-console-pg.yaml) |
| `kind`         | `Cluster` (`postgresql.cnpg.io/v1`, CloudNativePG / cloudnative-pg)|
| Cluster name   | `developer-console-pg`                                                   |
| Namespace      | `openfoundry`                                                      |
| Read/write DNS | `developer-console-pg-rw.openfoundry.svc.cluster.local:5432`             |
| Read-only DNS  | `developer-console-pg-ro.openfoundry.svc.cluster.local:5432`             |
| Database       | `developer_console`                                                       |
| App secret     | `developer-console-pg-app` (CNPG-managed; carries `username`, `password`, `uri`) |
| Backup secret  | `developer-console-pg-backup` (S3 credentials for barman-cloud)          |
...
`services.developer-console-service.envSecrets.DATABASE_URL`
