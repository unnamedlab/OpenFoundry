    ...
    match &trigger.kind {
        TriggerKind::Time(t) => InventoryTrigger::Time {
            ...
            flavor: match t.flavor {
                crate::pipeline_schedule::domain::trigger::CronFlavor::Unix5 => TriggerCronFlavor::Unix5,
                crate::pipeline_schedule::domain::trigger::CronFlavor::Quartz6 => TriggerCronFlavor::Quartz6,
            },
        },
