...
| Field          | Value                                                              |
|----------------|--------------------------------------------------------------------|
| Manifest       | [`infra/k8s/platform/manifests/cnpg/clusters/sql-warehousing-pg.yaml`](../../../infra/k8s/platform/manifests/cnpg/clusters/sql-warehousing-pg.yaml) |
| `kind`         | `Cluster` (`postgresql.cnpg.io/v1`, CloudNativePG / cloudnative-pg)|
| Cluster name   | `sql-warehousing-pg`                                                   |
| Namespace      | `openfoundry`                                                      |
| Read/write DNS | `sql-warehousing-pg-rw.openfoundry.svc.cluster.local:5432`             |
| Read-only DNS  | `sql-warehousing-pg-ro.openfoundry.svc.cluster.local:5432`             |
| Database       | `sql_warehousing`                                                       |
| App secret     | `sql-warehousing-pg-app` (CNPG-managed; carries `username`, `password`, `uri`) |
| Backup secret  | `sql-warehousing-pg-backup` (S3 credentials for barman-cloud)          |
...
`services.sql-warehousing-service.envSecrets.DATABASE_URL`
