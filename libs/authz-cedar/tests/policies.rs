...
const CASES: &[Case] = &[
    // ---- Default-deny baseline ----
    Case {
        name: "anon read public dataset same tenant allowed (no role gate)",
        role: None,
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
        action: "read",
        resource: ResourceKind::Dataset,
        expected: Decision::Allow,
    },
    Case {
        name: "anon read pii dataset same tenant with clearance allowed",
        role: None,
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: true,
        action: "read",
        resource: ResourceKind::Dataset,
        expected: Decision::Allow,
    ...
    Case {
        name: "anon read pii dataset same tenant without clearance denied",
        role: None,
        clearances: &[],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "anon cross-tenant read denied",
        role: None,
        clearances: &[],
        resource_markings: &[],
        same_tenant: false,
    ...
    Case {
        name: "anon write public dataset denied",
        role: None,
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "viewer reads public dataset same tenant",
        role: Some("viewer"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "viewer with pii reads public dataset",
        role: Some("viewer"),
        clearances: &["pii"],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "viewer reads pii without clearance denied",
        role: Some("viewer"),
        clearances: &[],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "viewer reads pii with pii clearance",
        role: Some("viewer"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "viewer reads pii+confidential with full clearance",
        role: Some("viewer"),
        clearances: &["pii", "confidential"],
        resource_markings: &["pii", "confidential"],
        same_tenant: true,
        action: "read",
        resource: ResourceKind::Dataset,
        expected: Decision::Allow,
    ...
    Case {
        name: "viewer reads pii+confidential with only pii denied",
        role: Some("viewer"),
        clearances: &["pii"],
        resource_markings: &["pii", "confidential"],
        same_tenant: true,
    ...
    Case {
        name: "viewer reads confidential with only pii denied",
        role: Some("viewer"),
        clearances: &["pii"],
        resource_markings: &["confidential"],
        same_tenant: true,
        action: "read",
        resource: ResourceKind::Dataset,
        expected: Decision::Deny,
    ...
    Case {
        name: "viewer with superset clearance reads pii",
        role: Some("viewer"),
        clearances: &["pii", "confidential", "secret"],
        resource_markings: &["pii"],
        same_tenant: true,
        action: "read",
        resource: ResourceKind::Dataset,
    ...
    Case {
        name: "analyst reads pii with clearance",
        role: Some("analyst"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "editor reads secret without clearance denied",
        role: Some("editor"),
        clearances: &["pii"],
        resource_markings: &["secret"],
        same_tenant: true,
        action: "read",
        resource: ResourceKind::Dataset,
        expected: Decision::Deny,
    ...
    Case {
        name: "viewer cross-tenant read public denied",
        role: Some("viewer"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: false,
    ...
    Case {
        name: "admin cross-tenant read public denied",
        role: Some("admin"),
        clearances: &["pii", "confidential"],
        resource_markings: &[],
        same_tenant: false,
    ...
    Case {
        name: "editor cross-tenant read pii denied",
        role: Some("editor"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: false,
    ...
    // ---- Write on Dataset ----
    Case {
        name: "viewer write public denied (not editor/admin)",
        role: Some("viewer"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "editor write public allowed",
        role: Some("editor"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "editor write pii without clearance denied",
        role: Some("editor"),
        clearances: &[],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "editor write pii with clearance allowed",
        role: Some("editor"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "admin write secret with full clearance allowed",
        role: Some("admin"),
        clearances: &["secret"],
        resource_markings: &["secret"],
        same_tenant: true,
    ...
    Case {
        name: "admin write secret without clearance denied",
        role: Some("admin"),
        clearances: &["pii"],
        resource_markings: &["secret"],
        same_tenant: true,
    ...
    Case {
        name: "editor cross-tenant write denied",
        role: Some("editor"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: false,
    ...
    Case {
        name: "analyst write public denied (not editor/admin)",
        role: Some("analyst"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "editor write multi-marking superset clearance",
        role: Some("editor"),
        clearances: &["pii", "confidential", "secret"],
        resource_markings: &["pii", "confidential"],
        same_tenant: true,
    ...
    Case {
        name: "editor write multi-marking partial clearance denied",
        role: Some("editor"),
        clearances: &["pii"],
        resource_markings: &["pii", "confidential"],
        same_tenant: true,
    ...
    // ---- Delete on Dataset ----
    Case {
        name: "viewer delete public denied",
        role: Some("viewer"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "editor delete public denied (not admin)",
        role: Some("editor"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "admin delete public allowed",
        role: Some("admin"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "admin delete pii with clearance",
        role: Some("admin"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "admin delete pii without clearance denied",
        role: Some("admin"),
        clearances: &[],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "admin delete secret with full clearance",
        role: Some("admin"),
        clearances: &["pii", "confidential", "secret"],
        resource_markings: &["secret"],
        same_tenant: true,
    ...
    Case {
        name: "admin cross-tenant delete denied",
        role: Some("admin"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: false,
    ...
    Case {
        name: "admin delete multi-marking partial clearance denied",
        role: Some("admin"),
        clearances: &["pii"],
        resource_markings: &["pii", "secret"],
        same_tenant: true,
        action: "delete",
        resource: ResourceKind::Dataset,
        expected: Decision::Deny,
    ...
    Case {
        name: "viewer branch::create denied",
        role: Some("viewer"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "editor branch::create public allowed",
        role: Some("editor"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "admin branch::create public allowed",
        role: Some("admin"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "editor branch::create pii without clearance denied",
        role: Some("editor"),
        clearances: &[],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "editor branch::create pii with clearance",
        role: Some("editor"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "admin branch::create cross-tenant denied",
        role: Some("admin"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: false,
    ...
    Case {
        name: "analyst branch::create denied (not editor/admin)",
        role: Some("analyst"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    // ---- Read on Branch ----
    Case {
        name: "viewer reads public branch allowed",
        role: Some("viewer"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "editor reads public branch allowed",
        role: Some("editor"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "admin reads public branch allowed",
        role: Some("admin"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "viewer reads pii branch (rule weak: still allow by role)",
        role: Some("viewer"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "ml_engineer (unknown role) reads branch denied",
        role: Some("ml_engineer"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
        action: "read",
    ...
    // ---- Edge cases ----
    Case {
        name: "user with empty clearances reads empty markings",
        role: Some("viewer"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "user with many clearances reads single marking",
        role: Some("viewer"),
        clearances: &["a", "b", "c", "d", "e", "pii"],
        resource_markings: &["pii"],
        same_tenant: true,
        action: "read",
        resource: ResourceKind::Dataset,
    ...
    Case {
        name: "user with clearances missing one marking denied",
        role: Some("viewer"),
        clearances: &["a", "b", "c"],
        resource_markings: &["a", "b", "c", "d"],
        same_tenant: true,
        action: "read",
        resource: ResourceKind::Dataset,
        expected: Decision::Deny,
    ...
    Case {
        name: "admin role write public same tenant",
        role: Some("admin"),
        clearances: &[],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "user with admin+viewer role reads pii with clearance",
        role: Some("admin"),
        clearances: &["pii"],
        resource_markings: &["pii"],
        same_tenant: true,
    ...
    Case {
        name: "editor delete attempts denied even with clearance",
        role: Some("editor"),
        clearances: &["pii", "secret"],
        resource_markings: &["pii"],
        same_tenant: true,
        action: "delete",
        resource: ResourceKind::Dataset,
    ...
    Case {
        name: "viewer write denied even with all clearances",
        role: Some("viewer"),
        clearances: &["pii", "secret"],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "admin branch::create with full clearances on multi-marking",
        role: Some("admin"),
        clearances: &["pii", "confidential", "secret"],
        resource_markings: &["pii", "confidential"],
        same_tenant: true,
    ...
    Case {
        name: "editor branch::create on multi-marking missing one denied",
        role: Some("editor"),
        clearances: &["pii"],
        resource_markings: &["pii", "secret"],
        same_tenant: true,
    ...
    Case {
        name: "viewer reads pii dataset same tenant with extra clearances",
        role: Some("viewer"),
        clearances: &["pii", "secret", "confidential", "other"],
        resource_markings: &["pii"],
        same_tenant: true,
        action: "read",
        resource: ResourceKind::Dataset,
    ...
    Case {
        name: "anon branch::create denied",
        role: None,
        clearances: &["pii"],
        resource_markings: &[],
        same_tenant: true,
    ...
    Case {
        name: "editor delete cross-tenant denied",
        role: Some("editor"),
        clearances: &["pii"],
        resource_markings: &[],
        same_tenant: false,
...
fn uid(type_name: &str, id: &str) -> EntityUid {
    use std::str::FromStr;
    EntityUid::from_type_name_and_id(ty(type_name), EntityId::from_str(id).expect("entity id"))
}
...
fn matrix_runs() {
    ...
    for case in CASES {
        ...
        let entities =
            Entities::from_entities(all, Some(&store.schema())).expect("entities hydrate");
