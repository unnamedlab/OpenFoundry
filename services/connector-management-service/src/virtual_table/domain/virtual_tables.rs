...
//! [`crate::virtual_table::domain::audit`] and bump a Prometheus counter
...
use crate::virtual_table::domain::audit;
use crate::virtual_table::domain::capability_matrix::{Capabilities, SourceProvider, TableType, capabilities_for};
use crate::virtual_table::domain::iceberg_catalogs::{self, CatalogKind};
use crate::virtual_table::domain::schema_inference;
use crate::virtual_table::domain::source_validation::{self, RejectionReason};
...
pub async fn capabilities_summary(provider: SourceProvider) -> Vec<(TableType, Capabilities)> {
    crate::virtual_table::domain::capability_matrix::iter_cells()
