...
* [`pg-schemas-bootstrap-sql.yaml`](../cnpg/clusters/pg-schemas-bootstrap-sql.yaml) — 23 schemas
* [`pg-policy-bootstrap-sql.yaml`](../cnpg/clusters/pg-policy-bootstrap-sql.yaml) — 12 schemas + Debezium role
* [`pg-runtime-config-bootstrap-sql.yaml`](../cnpg/clusters/pg-runtime-config-bootstrap-sql.yaml) — 23 schemas
