...
//!
//! Pure-logic tests over `pipeline_build_service::pipeline_authoring::lifecycle`. Covers
...
use pipeline_build_service::pipeline_authoring::lifecycle::{LifecycleError, PipelineLifecycle};
