...
use ingestion_replication_service::event_streaming::handlers::push_proxy::{
...
mod with_redpanda {
    ...
    use ingestion_replication_service::event_streaming::domain::hot_buffer::{HotBuffer, KafkaHotBuffer};
