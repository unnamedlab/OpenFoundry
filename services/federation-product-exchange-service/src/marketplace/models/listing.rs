...
use crate::marketplace::models::{decode_json, package::PackageVersion, review::ListingReview};
...
pub struct ListingDefinition {
    ...
    pub package_kind: crate::marketplace::models::package::PackageType,
...
impl TryFrom<ListingRow> for ListingDefinition {
    ...
    fn try_from(row: ListingRow) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            package_kind: crate::marketplace::models::package::PackageType::from_str(&row.package_kind)?,
