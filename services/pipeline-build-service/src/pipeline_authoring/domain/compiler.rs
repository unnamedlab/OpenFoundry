...
pub fn validate_definition(
    ...
    for node in nodes {
        ...
        if crate::pipeline_authoring::domain::media_nodes::is_media_transform_type(&node.transform_type) {
            for issue in
                crate::pipeline_authoring::domain::media_nodes::validate_media_node(&node.transform_type, &node.config)
            {
