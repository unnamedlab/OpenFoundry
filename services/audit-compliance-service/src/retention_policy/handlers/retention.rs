...
pub async fn create_policy(
    ...
    let row = sqlx::query_as::<_, crate::retention_policy::models::retention::RetentionPolicyRow>(
...
pub async fn delete_policy(
    State(state): State<AppState>,
    Path(policy_id): Path<Uuid>,
) -> Result<StatusCode, (StatusCode, Json<crate::retention_policy::handlers::ErrorResponse>)> {
    ...
    if existing.is_system {
        return Err((
            StatusCode::CONFLICT,
            Json(crate::retention_policy::handlers::ErrorResponse {
...
pub async fn list_jobs(State(state): State<AppState>) -> ServiceResult<Vec<RetentionJob>> {
    let rows = sqlx::query_as::<_, crate::retention_policy::models::retention::RetentionJobRow>(
...
pub struct InheritedPolicies {
    pub org: Vec<crate::retention_policy::models::retention::RetentionPolicy>,
    pub space: Vec<crate::retention_policy::models::retention::RetentionPolicy>,
    pub project: Vec<crate::retention_policy::models::retention::RetentionPolicy>,
}
...
pub struct ApplicablePoliciesResponse {
    ...
    pub explicit: Vec<crate::retention_policy::models::retention::RetentionPolicy>,
    pub effective: Option<crate::retention_policy::models::retention::RetentionPolicy>,
...
pub async fn applicable_policies(
    ...
    crate::retention_policy::metrics::RETENTION_APPLICABLE_TOTAL
...
pub struct RetentionPreviewResponse {
    ...
    pub effective_policy: Option<crate::retention_policy::models::retention::RetentionPolicy>,
...
pub async fn retention_preview(
    ...
    let bucket = crate::retention_policy::metrics::preview_bucket(as_of_days);
    crate::retention_policy::metrics::RETENTION_PREVIEW_TOTAL
