...
use crate::virtual_table::domain::capability_matrix::{SourceProvider, TableType};
...
pub async fn enable(
...
) -> Result<crate::virtual_table::models::virtual_table::VirtualTableSourceLink> {
    ...
    let row: crate::virtual_table::models::virtual_table::VirtualTableSourceLink = sqlx::query_as(
...
async fn load_existing(
    ...
    let rows: Vec<crate::virtual_table::models::virtual_table::VirtualTableRow> = sqlx::query_as(
...
async fn apply_diff(
    ...
    for table in &diff.added {
        ...
        .bind(serde_json::to_value(crate::virtual_table::domain::capability_matrix::capabilities_for(
            config.provider,
            table.table_type,
        ))
        .unwrap_or(json!({})))
