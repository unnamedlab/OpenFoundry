...
-> ServiceResult<Vec<crate::security_governance::models::governance::GovernanceTemplate>> {
    Ok(Json(templates::governance_template_catalog()))
}

pub async fn list_governance_template_applications(
    State(state): State<AppState>,
) -> ServiceResult<ListResponse<crate::security_governance::models::governance::GovernanceTemplateApplication>> {
