...
//!
//! The HTTP handlers in `crate::virtual_table::handlers::virtual_tables` and this gRPC
//! server are sibling adapters over `crate::virtual_table::domain::virtual_tables`,
...
use crate::virtual_table::domain::virtual_tables::{self, RegistrationKind};
...
fn locator_value_to_proto(value: &serde_json::Value) -> Option<ProtoLocator> {
    ...
    match kind {
        "tabular" => Some(ProtoLocator {
            kind: Some(LocatorKind::Tabular(crate::virtual_table::proto::TabularLocator {
                database: value
                    .get("database")
                    .and_then(|v| v.as_str())
                    .unwrap_or_default()
        ...
        "file" => Some(ProtoLocator {
            kind: Some(LocatorKind::File(crate::virtual_table::proto::FileLocator {
                bucket: value
                    .get("bucket")
                    .and_then(|v| v.as_str())
                    .unwrap_or_default()
        ...
        "iceberg" => Some(ProtoLocator {
            kind: Some(LocatorKind::Iceberg(crate::virtual_table::proto::IcebergLocator {
                catalog: value
                    .get("catalog")
                    .and_then(|v| v.as_str())
                    .unwrap_or_default()
