-- Analytical-expressions persistence (absorbed from analytical-logic-service,
-- ADR-0030 S8). Mirrors `0003_analytical_expressions_foundation.sql` in
-- the helm pre-install Job.
