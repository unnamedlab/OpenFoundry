...
//! [`ingestion_replication_service::event_streaming::models::window::key_prefix_for`] helper
//! is the deterministic part of that contract.

use chrono::Utc;
use ingestion_replication_service::event_streaming::models::window::{WindowDefinition, key_prefix_for};
use serde_json::json;
use uuid::Uuid;
