...
pub fn connector_profiles() -> Vec<ConnectorContractProfile> {
    vec![
        ...
        warehouse_profile("databricks", "Databricks"),
        object_store_profile("s3", "Amazon S3"),
        object_store_profile("azure_blob", "Azure Blob"),
        object_store_profile("adls", "Azure Data Lake Storage"),
        object_store_profile("onelake", "Microsoft OneLake"),
        object_store_profile("gcs", "Google Cloud Storage"),
        object_store_profile("google_cloud_storage", "Google Cloud Storage"),
        object_store_profile("parquet", "Parquet file"),
        object_store_profile("csv", "CSV file"),
        object_store_profile("json", "JSON file"),
        object_store_profile("generic", "Generic open-table catalog"),
        event_bus_profile("kafka", "Kafka"),
        event_bus_profile("kinesis", "Amazon Kinesis"),
        event_bus_profile("iot", "IoT / IIoT feed"),
        saas_profile("salesforce", "Salesforce"),
        saas_profile("rest_api", "REST API"),
