...
pub async fn create_policy(
    ...
    .bind(match body.sensitivity {
        crate::checkpoints_purpose::models::checkpoint::InteractionSensitivity::Critical => "critical",
        crate::checkpoints_purpose::models::checkpoint::InteractionSensitivity::High => "high",
        crate::checkpoints_purpose::models::checkpoint::InteractionSensitivity::Normal => "normal",
    })
