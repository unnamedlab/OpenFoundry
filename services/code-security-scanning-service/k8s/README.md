...
| Field          | Value                                                              |
|----------------|--------------------------------------------------------------------|
| Manifest       | [`infra/k8s/platform/manifests/cnpg/clusters/code-security-scanning-pg.yaml`](../../../infra/k8s/platform/manifests/cnpg/clusters/code-security-scanning-pg.yaml) |
