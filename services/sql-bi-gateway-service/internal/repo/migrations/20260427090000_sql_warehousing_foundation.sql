-- Warehousing jobs / transformations / storage artifacts (absorbed
-- from sql-warehousing-service, ADR-0030 S8). Mirrors
-- `0004_sql_warehousing_foundation.sql` in the helm pre-install Job.
