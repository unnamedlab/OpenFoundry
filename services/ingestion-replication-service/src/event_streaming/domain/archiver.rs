...
use crate::event_streaming::domain::runtime_store::{ColdArchiveRecord, SharedRuntimeStore};
use crate::event_streaming::storage::{DatasetSnapshot, DatasetWriter, WriterError};
...
enum ArchiverError {
    ...
    Runtime(crate::event_streaming::domain::runtime_store::RuntimeStoreError),
