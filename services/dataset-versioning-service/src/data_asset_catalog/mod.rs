...
use crate::data_asset_catalog::config::LakehousePrefixes;
use crate::data_asset_catalog::domain::markings::MarkingResolver;
...
pub fn build_router(state: AppState) -> Router {
    ...
    crate::data_asset_catalog::metrics::init();
