...
pub async fn load_listings(
    db: &sqlx::PgPool,
) -> Result<Vec<crate::marketplace::models::listing::ListingDefinition>, sqlx::Error> {
    ...
    rows.into_iter()
        .map(crate::marketplace::models::listing::ListingDefinition::try_from)
...
pub async fn load_versions(
...
) -> Result<Vec<crate::marketplace::models::package::PackageVersion>, sqlx::Error> {
    ...
    rows.into_iter()
        .map(crate::marketplace::models::package::PackageVersion::try_from)
        .collect::<Result<Vec<_>, _>>()
        .map_err(|cause| {
            sqlx::Error::Decode(Box::new(std::io::Error::new(
                std::io::ErrorKind::InvalidData,
...
pub async fn load_reviews(
    db: &sqlx::PgPool,
    listing_id: uuid::Uuid,
) -> Result<Vec<crate::marketplace::models::review::ListingReview>, sqlx::Error> {
    ...
    rows.into_iter()
        .map(crate::marketplace::models::review::ListingReview::try_from)
        .collect::<Result<Vec<_>, _>>()
        .map_err(|cause| {
            sqlx::Error::Decode(Box::new(std::io::Error::new(
                std::io::ErrorKind::InvalidData,
...
pub async fn load_installs(
    db: &sqlx::PgPool,
) -> Result<Vec<crate::marketplace::models::install::InstallRecord>, sqlx::Error> {
    ...
    rows.into_iter()
        .map(crate::marketplace::models::install::InstallRecord::try_from)
        .collect::<Result<Vec<_>, _>>()
        .map_err(|cause| {
            sqlx::Error::Decode(Box::new(std::io::Error::new(
                std::io::ErrorKind::InvalidData,
