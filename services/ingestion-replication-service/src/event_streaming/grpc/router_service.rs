...
use crate::event_streaming::backends::{Backend, BackendError, BackendRegistry, Envelope};
use crate::event_streaming::metrics::{self, Metrics, publish_result, resolution_result};
use crate::event_streaming::proto::router::{
    EventMessage, PublishRequest, PublishResponse, SubscribeRequest,
    event_router_server::{EventRouter, EventRouterServer},
};
use crate::event_streaming::router::{BackendId, ResolvedRoute, RouteTable};
...
mod tests {
    use super::*;
    use crate::event_streaming::backends::{Backend, BackendError, EnvelopeStream};
    use crate::event_streaming::router::{BackendId, CompiledRoute, RouteTable};
