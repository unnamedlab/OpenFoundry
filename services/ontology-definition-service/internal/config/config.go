// Package config resolves ontology-definition-service env config.
package config
...
func FromEnv() (*Config, error) {
	...
	cfg.PGSchema = defaultStr(os.Getenv("PG_SCHEMA"), "ontology_schema")
