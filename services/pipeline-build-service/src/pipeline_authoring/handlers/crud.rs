...
use crate::pipeline_authoring::AppState;
use crate::pipeline_authoring::domain::lifecycle::PipelineLifecycle;
use crate::pipeline_authoring::domain::pipeline_type::{
    self, ExternalConfig, IncrementalConfig, PipelineType, StreamingConfig,
};
use crate::pipeline_authoring::domain::{compiler, executor};
use crate::pipeline_authoring::models::authoring::PipelineValidationResponse;
use crate::pipeline_authoring::models::pipeline::*;
...
fn synthesize_seed_nodes(
    ...
    inputs: &[crate::pipeline_authoring::models::pipeline::PipelineInputSeed],
) -> Vec<crate::pipeline_authoring::models::pipeline::PipelineNode> {
    use crate::pipeline_authoring::models::pipeline::PipelineNode;
