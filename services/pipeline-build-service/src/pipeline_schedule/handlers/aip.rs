...
//! ```
//!
//! Both endpoints delegate to the [`crate::pipeline_schedule::domain::aip`] module. The
...
use crate::pipeline_schedule::domain::aip::{
    AipError, LlmClient, run_explain, run_generate,
};
use crate::pipeline_schedule::domain::metrics;
use crate::pipeline_schedule::domain::trigger::{ScheduleTarget, Trigger};
