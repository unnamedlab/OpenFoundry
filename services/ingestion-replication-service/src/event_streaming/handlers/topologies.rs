...
async fn load_all_streams(
    db: &sqlx::PgPool,
) -> Result<Vec<crate::event_streaming::models::stream::StreamDefinition>, sqlx::Error> {
...
async fn load_all_windows(
    db: &sqlx::PgPool,
) -> Result<Vec<crate::event_streaming::models::window::WindowDefinition>, sqlx::Error> {
...
pub async fn get_overview(
    ...
    let all_streams: Vec<crate::event_streaming::models::stream::StreamDefinition> =
...
pub async fn create_topology(
    ...
    streaming_outbox::emit(&mut tx, &streaming_outbox::topology_created(&definition))
        ...
        .map_err(|cause| {
            ...
            crate::event_streaming::handlers::internal_error("failed to enqueue outbox event")
        })?;
...
mod tests {
    ...
    use crate::event_streaming::models::{
    ...
    fn sample_stream(id: Uuid, name: &str) -> StreamDefinition {
        StreamDefinition {
            ...
            stream_profile: crate::event_streaming::models::stream::StreamProfile::default(),
            schema_avro: None,
            schema_fingerprint: None,
            schema_compatibility_mode: "BACKWARD".to_string(),
            default_marking: None,
            stream_type: crate::event_streaming::models::stream::StreamType::default(),
            compression: false,
            ingest_consistency:
                crate::event_streaming::models::stream::StreamConsistency::AtLeastOnce,
            pipeline_consistency:
                crate::event_streaming::models::stream::StreamConsistency::AtLeastOnce,
            checkpoint_interval_ms: 2_000,
            kind: crate::event_streaming::models::stream_view::StreamKind::Ingest,
            created_at: Utc::now(),
            updated_at: Utc::now(),
        }
    }
