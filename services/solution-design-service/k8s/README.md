...
| Field          | Value                                                              |
|----------------|--------------------------------------------------------------------|
| Manifest       | [`infra/k8s/platform/manifests/cnpg/clusters/solution-design-pg.yaml`](../../../infra/k8s/platform/manifests/cnpg/clusters/solution-design-pg.yaml) |
| `kind`         | `Cluster` (`postgresql.cnpg.io/v1`, CloudNativePG / cloudnative-pg)|
| Cluster name   | `solution-design-pg`                                                   |
| Namespace      | `openfoundry`                                                      |
| Read/write DNS | `solution-design-pg-rw.openfoundry.svc.cluster.local:5432`             |
| Read-only DNS  | `solution-design-pg-ro.openfoundry.svc.cluster.local:5432`             |
| Database       | `solution_design`                                                       |
| App secret     | `solution-design-pg-app` (CNPG-managed; carries `username`, `password`, `uri`) |
| Backup secret  | `solution-design-pg-backup` (S3 credentials for barman-cloud)          |
...
`services.solution-design-service.envSecrets.DATABASE_URL`
