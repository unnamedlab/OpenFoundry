//! Environment-driven configuration for `ontology-security-service`.
//!
...
//! The security binary owns `/api/v1/ontology/rules/*` and the
//! per-type/per-object rule routes per
...
pub struct AppConfig {
    ...
    /// rule handlers do not publish events from this binary today.
