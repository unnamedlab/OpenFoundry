...
//! adapters over `crate::virtual_table::domain::virtual_tables`; business logic and
...
use crate::virtual_table::AppState;
use crate::virtual_table::domain::auto_registration::{
    self, AutoRegistrationError, EnableAutoRegistrationRequest,
};
use crate::virtual_table::domain::iceberg_catalogs::CatalogKind;
use crate::virtual_table::domain::update_detection::{self, UpdateDetectionError, UpdateDetectionToggle};
use crate::virtual_table::domain::virtual_tables::{self, RegistrationKind, VirtualTableError};
use crate::virtual_table::models::virtual_table::{
...
pub async fn auto_registration_scan_now(
    ...
    let result = auto_registration::run_once(
        ...
        &auto_registration::SourceAutoRegisterConfig {
            ...
            provider: crate::virtual_table::domain::capability_matrix::SourceProvider::BigQuery,
...
use crate::virtual_table::domain::code_imports::{
