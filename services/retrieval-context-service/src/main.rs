...
#[tokio::main]
async fn main() {
    observability::init_tracing("retrieval-context-service");
    ...
    let public = Router::new().route(
        "/health",
        get(|| async { axum::Json(HealthStatus::ok("retrieval-context-service")) }),
    );
    ...
    tracing::info!("starting retrieval-context-service on {addr}");
