...
| Field          | Value                                                              |
|----------------|--------------------------------------------------------------------|
| Manifest       | [`infra/k8s/platform/manifests/cnpg/clusters/tabular-analysis-pg.yaml`](../../../infra/k8s/platform/manifests/cnpg/clusters/tabular-analysis-pg.yaml) |
| `kind`         | `Cluster` (`postgresql.cnpg.io/v1`, CloudNativePG / cloudnative-pg)|
| Cluster name   | `tabular-analysis-pg`                                                   |
| Namespace      | `openfoundry`                                                      |
| Read/write DNS | `tabular-analysis-pg-rw.openfoundry.svc.cluster.local:5432`             |
| Read-only DNS  | `tabular-analysis-pg-ro.openfoundry.svc.cluster.local:5432`             |
| Database       | `tabular_analysis`                                                       |
| App secret     | `tabular-analysis-pg-app` (CNPG-managed; carries `username`, `password`, `uri`) |
| Backup secret  | `tabular-analysis-pg-backup` (S3 credentials for barman-cloud)          |
...
`services.tabular-analysis-service.envSecrets.DATABASE_URL`
