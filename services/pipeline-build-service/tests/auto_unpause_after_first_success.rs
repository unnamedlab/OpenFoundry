...
use pipeline_build_service::pipeline_schedule::domain::build_client::BuildAttemptOutcome;
use pipeline_build_service::pipeline_schedule::domain::dispatcher::{
    AutoPauseConfig, DispatchTrigger, Dispatcher, DispatcherConfig,
};
use pipeline_build_service::pipeline_schedule::domain::trigger::AUTO_PAUSED_REASON;
use pipeline_build_service::pipeline_schedule::domain::{schedule_store, trigger::Schedule};
