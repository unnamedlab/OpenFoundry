...
use chrono::Utc;
use ingestion_replication_service::event_streaming::domain::connectors::kinesis::{
    KinesisConfig, KinesisConnector, KinesisRecord, StaticKinesisClient,
};
use ingestion_replication_service::event_streaming::domain::connectors::source_trait::{
