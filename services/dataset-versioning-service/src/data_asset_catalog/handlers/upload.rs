...
use crate::data_asset_catalog::{AppState, domain::runtime};
...
pub async fn upload_data(
    ...
    if let Err(resp) = crate::data_asset_catalog::security::require_dataset_write(&claims, &dataset_id.to_string()) {
    ...
    crate::data_asset_catalog::security::emit_audit(
        &claims.sub,
