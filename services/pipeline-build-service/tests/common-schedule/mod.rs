...
use pipeline_build_service::pipeline_schedule::domain::build_client::{
    BuildAttemptOutcome, BuildServiceClient, CreateBuildPayload,
};
use pipeline_build_service::pipeline_schedule::domain::notification_client::{AutoPausedAlert, NotificationClient};
use sqlx::PgPool;
...
use pipeline_build_service::pipeline_schedule::domain::schedule_store;
...
pub async fn create_pipeline_build_schedule(
    pool: &PgPool,
    name: &str,
) -> pipeline_build_service::pipeline_schedule::domain::trigger::Schedule {
