...
use crate::event_streaming::models::stream::StreamDefinition;
use crate::event_streaming::models::topology::TopologyDefinition;
use crate::event_streaming::runtime::flink::sql::{RenderedFlinkSql, render_flink_sql};
use crate::event_streaming::runtime::flink::{FlinkJobCoords, FlinkRuntimeConfig};
...
mod tests {
    ...
    fn sample_topology() -> TopologyDefinition {
        ...
        TopologyDefinition {
            ...
            cep_definition: None,
            backpressure_policy:
                crate::event_streaming::models::topology::BackpressurePolicy::default(),
