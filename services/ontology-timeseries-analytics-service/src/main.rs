...
async fn main() {
    ...
    let protected = Router::new()
        ...
        .route(
            "/api/v1/ontology-timeseries/dashboards/{id}",
            get(handlers::get_item),
        )
        .route(
            "/api/v1/ontology-timeseries/dashboards/{id}/secondary",
    ...
    tracing::info!("starting ontology-timeseries-analytics-service on {addr}");
