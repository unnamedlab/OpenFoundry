...
use crate::retention_policy::models::retention::{
...
pub fn filter_policies(
    ...
    query: &crate::retention_policy::handlers::retention::ListPoliciesQuery,
) -> Vec<RetentionPolicy> {
    policies
        .into_iter()
...
use crate::retention_policy::handlers::retention::{
...
mod tests {
    use super::*;
    use crate::retention_policy::handlers::retention::ListPoliciesQuery;
    use crate::retention_policy::models::retention::{RetentionCriteria, RetentionSelector};
    use chrono::Utc;
