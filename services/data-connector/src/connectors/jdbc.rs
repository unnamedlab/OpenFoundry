...
const CONNECTOR_NAME: &str = "jdbc";
const DEFAULT_SOURCE_KIND: &str = "jdbc_table";

pub fn validate_config(config: &Value) -> Result<(), String> {
    catalog_bridge::validate_tabular_connector_config(config, CONNECTOR_NAME, &["jdbc_url"])
}
...
mod tests {
    ...
    #[test]
    fn accepts_inline_table_catalogs() {
        let config = json!({
