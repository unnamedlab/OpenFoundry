...
#[tokio::main]
async fn main() {
    observability::init_tracing("tool-registry-service");
    ...
    let public = Router::new().route(
        "/health",
        get(|| async { axum::Json(HealthStatus::ok("tool-registry-service")) }),
    );
    ...
    tracing::info!("starting tool-registry-service on {addr}");
