...
#[tokio::main]
async fn main() {
    observability::init_tracing("model-catalog-service");
    ...
    let public = Router::new().route(
        "/health",
        get(|| async { axum::Json(HealthStatus::ok("model-catalog-service")) }),
    );
    ...
    tracing::info!("starting model-catalog-service on {addr}");
