...
const CONNECTOR_NAME: &str = "tableau";
const DEFAULT_SOURCE_KIND: &str = "tableau_view";

pub fn validate_config(config: &Value) -> Result<(), String> {
    catalog_bridge::validate_tabular_connector_config(config, CONNECTOR_NAME, &["site_id"])
}
...
mod tests {
    ...
    #[test]
    fn accepts_inline_view_catalogs() {
        let config = json!({
            "site_id": "openfoundry",
            "views": [
                {
