...
use crate::dataset_quality::AppState;
use crate::dataset_quality::domain::health::{ComputedHealth, compute_health};
use crate::dataset_quality::models::health::{DatasetHealth, DatasetHealthRow};
...
fn publish_metrics(rid: &str, computed: &ComputedHealth) {
    crate::dataset_quality::metrics::DATASET_FRESHNESS_SECONDS
        .with_label_values(&[rid])
        .set(computed.freshness_seconds);
    crate::dataset_quality::metrics::DATASET_ROW_COUNT
        .with_label_values(&[rid])
    ...
    if let Some(aborted) = computed
        ...
        .and_then(|v| v.as_i64())
    {
        crate::dataset_quality::metrics::DATASET_TXN_FAILURES_TOTAL
            .with_label_values(&[rid])
            .reset();
        crate::dataset_quality::metrics::DATASET_TXN_FAILURES_TOTAL
            .with_label_values(&[rid])
