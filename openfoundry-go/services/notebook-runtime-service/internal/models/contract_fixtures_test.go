...
type notebookContractFixture struct {
	Notebook Notebook             `json:"notebook"`
	Cell     Cell                 `json:"cell"`
	Export   NotepadExportPayload `json:"export"`
}

func TestNotebookJSONContractFixture(t *testing.T) {
	assertFixtureRoundTrip(t, "testdata/notebook_session_export.json", &notebookContractFixture{})
}
