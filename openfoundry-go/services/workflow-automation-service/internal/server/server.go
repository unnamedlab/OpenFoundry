...
// workflow-automation-service. The full /api/v1 surface (workflow
// CRUD, automation runs, approvals decide path) lands in
// follow-up slices alongside the saga + approval + condition consumers.
package server
