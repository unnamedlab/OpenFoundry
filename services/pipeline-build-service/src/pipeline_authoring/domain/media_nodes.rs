...
//! serde_json::Value` (see `crate::pipeline_authoring::models::pipeline::PipelineNode`).
...
//! ([`crate::pipeline_authoring::domain::engine::runtime::execute_media_node_stub`]). The
...
/// in `crate::pipeline_authoring::domain::compiler` aggregate these into the pipeline-level
/// validation response.
///
