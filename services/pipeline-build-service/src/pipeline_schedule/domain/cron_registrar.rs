...
use crate::pipeline_schedule::domain::cron_dispatch::CronClause;
use crate::pipeline_schedule::domain::trigger::{Schedule, ScheduleTargetKind};
...
mod tests {
    ...
    fn schedule_with_target(target: ScheduleTarget) -> Schedule {
        Schedule {
            ...
            name: "test".into(),
            description: "".into(),
            trigger: crate::pipeline_schedule::domain::trigger::Trigger {
                kind: crate::pipeline_schedule::domain::trigger::TriggerKind::Time(
                    crate::pipeline_schedule::domain::trigger::TimeTrigger {
                        cron: "* * * * *".into(),
                        time_zone: "UTC".into(),
                        flavor: crate::pipeline_schedule::domain::trigger::CronFlavor::Unix5,
                    },
                ),
            },
            target,
    ...
    fn payload_pipeline_rid_is_null_for_sync_target() {
        let s = schedule_with_target(ScheduleTarget {
            kind: ScheduleTargetKind::SyncRun(crate::pipeline_schedule::domain::trigger::SyncRunTarget {
